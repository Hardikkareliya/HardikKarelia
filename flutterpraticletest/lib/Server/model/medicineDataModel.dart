class MedicineDataModel {
  ...
  MedicineDataModel({this.problems});

  MedicineDataModel.fromJson(Map<String, dynamic> json) {
...
class Problems {
  ...
  Problems.fromJson(Map<String, dynamic> json) {
    ...
    if (json['Asthma'] != null) {
      asthma = new List<Asthma>();
      json['Asthma'].forEach((v) { asthma.add(new Asthma.fromJson(v)); });
    }
  }
...
class Medications {
  ...
  Medications.fromJson(Map<String, dynamic> json) {
    if (json['medicationsClasses'] != null) {
      medicationsClasses = new List<MedicationsClasses>();
